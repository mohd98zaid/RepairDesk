        ...
        <>
            ...
            <aside className="admin-nav admin-nav--desktop">
                ...
                <nav className="admin-nav__links">
                    ...
                    <a href="http://localhost:8000/api/v1/sqladmin" target="_blank" rel="noopener noreferrer" className="admin-nav__link">
                        <Store size={18} />Database Viewer
                    </a>
                    <a href="http://localhost:8000/docs" target="_blank" rel="noopener noreferrer" className="admin-nav__link">
