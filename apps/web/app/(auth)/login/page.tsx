...
import { Wrench, Eye, EyeOff, Loader2, MonitorSmartphone, ShieldAlert, RotateCcw, LogIn, ShieldX, Sun, Moon } from "lucide-react";
...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        setDark(saved !== 'light');
        // Listen for cross-tab theme changes broadcast by AppShell
        try {
        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-background">
            ...
            <div className="relative w-full max-w-md">
                <div className="flex items-center gap-3 mb-8 justify-center">
                    <img src="/logo.png" alt="RepairDeskz" className="h-16 w-[220px] object-contain bg-white rounded-xl px-4 py-2 shadow-lg" />
                </div>
