...
class Ticket(Base):
    ...
    # Relationships
    charges: Mapped[list["TicketCharge"]] = sqlalchemy.orm.relationship(
        "TicketCharge", back_populates="ticket", cascade="all, delete-orphan",
        order_by="TicketCharge.created_at"
    )
...
class TicketCharge(Base):
    __tablename__ = "ticket_charges"
    ...
    # Relationship
    ticket: Mapped["Ticket"] = sqlalchemy.orm.relationship("Ticket", back_populates="charges")
